    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-home"></i><span>@lang('site.dashboard')</span></a></li>
             ...
             @if (auth()->user()->hasPermission('read_categories'))
                <li><a href="{{ route('dashboard.categories.index') }}"><i class="fa fa-puzzle-piece"></i><span>@lang('site.categories')</span></a></li>
            @endif
        ...
        @endif --}}
            ...
            @if (auth()->user()->hasPermission('read_users'))
                <li><a href="{{ route('dashboard.users.index') }}"><i class="fa fa-user-plus"></i><span>@lang('site.users')</span></a></li>
            @endif
